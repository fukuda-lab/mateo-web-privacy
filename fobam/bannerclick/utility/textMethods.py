...
def remove_classes(
    html: str,
):  # remove all the classes from the tags in a given HTML string (used for rendering banner without access to corresponding CSS files.
