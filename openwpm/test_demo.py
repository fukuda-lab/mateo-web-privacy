...
fb = FirefoxBinary(firefox_path='/home/mateoormeno/mateo-web-privacy/openwpm/firefox-bin/firefox-bin')
fo = Options()
fo.headless = True
...
# OLD DEMO CODE FROM WHEN THE OPENWPM REPOSITORY WAS CLONED THE FIRST TIME
