...
class Categorizer:
    ...
    async def categorize(self, session: aiohttp.ClientSession, url: str, taxonomy: str = "iabv1") -> dict:
        """
        ...
        async with session.get(api_url) as response:
            ...
            if status_code == 200:
                ...
                return {"status_code": status_code, "categories_response": categories_response}
            elif status_code == 202:
                return {"status_code": status_code, "status": "pending", "message": "Categories are being calculated. Check back soon."}
            else:
                return {"status_code": status_code, "data": data}  # This will return the error message provided by the API or other status